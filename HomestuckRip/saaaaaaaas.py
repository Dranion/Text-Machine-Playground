...
while (number < final):
	if(number > 1000, number < 10000):
		hs = urllib.request.urlopen("http://www.mspaintadventures.com/?s=6&p=00" +str(number))
	else: 
		hs = urllib.request.urlopen("http://www.mspaintadventures.com/?s=6&p=0" +str(number))
